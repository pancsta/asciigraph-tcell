...
func CaptionColor(ac tcell.Color) Option {
	return optionFunc(func(c *config) {
		c.CaptionColor = ac
	})
}
...
func AxisColor(ac tcell.Color) Option {
	return optionFunc(func(c *config) {
		c.AxisColor = ac
	})
}
...
func LabelColor(ac tcell.Color) Option {
	return optionFunc(func(c *config) {
		c.LabelColor = ac
	})
}
...
func SeriesColors(ac ...tcell.Color) Option {
	return optionFunc(func(c *config) {
		c.SeriesColors = ac
	})
}
